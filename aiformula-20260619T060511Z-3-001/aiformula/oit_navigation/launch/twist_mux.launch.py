...
def generate_launch_description():
    ...
    LAUNCHERS_DIR = get_package_share_directory("oit_navigation")
            ...
            *ROS_PARAM_CONFIG,
            {
                ...
                "topics.key_board_controller.topic": "/aiformula_control/key_board_controller/cmd_vel",
                "topics.red_cone_controller.topic": "/aiformula_control/red_cone_controller/cmd_vel",
                "topics.lane_line_controller.topic": "/aiformula_control/lane_line_controller/cmd_vel",
                "locks.key_board_controller.topic": "/aiformula_control/twist_mux/key_board_controller/lock",
            },
        ],
        remappings=[
